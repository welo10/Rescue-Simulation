...
public class Simulator implements WorldListener {
	...
	private void loadUnits(String path) throws UnitException, Exception {
...
//		}
	...
	public String toString() {
		...
		for(int k=0;k<emergencyUnits.size();k++) {
			if(emergencyUnits.get(k).getState()==UnitState.IDLE) {
				s+=emergencyUnits.get(k).toString();
			}
		}
		return s;
	}
